...
class Course(models.Model):
    ...
    main_img = models.ImageField(upload_to='courses', null=True, blank=True, verbose_name='Изображение')
...
class StudentsHomework(models.Model):
    ...
    HOMEWORK_STATUS_CHOICES = ((HOMEWORK_STATUS_NOT_DONE, "not done"),
                               (HOMEWORK_STATUS_ON_REVIEW, "on review"),
                               (HOMEWORK_STATUS_SEND_TO_REWORK, "send to rework"),
                               (HOMEWORK_STATUS_COMPLETE, "complete")
                               )
